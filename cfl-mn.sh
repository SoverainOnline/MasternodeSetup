...
cryptoflow-cli stop > /dev/null 2>&1
wget https://github.com/CryptoFlowCoin/CryptoFlowCoin/releases/download/v1.2.0.0/CFL1200-daemon.zip -O /tmp/CFL1200-daemon.zip
unzip /tmp/CFL1200-daemon.zip -d /usr/local/bin/
chmod +x /usr/local/bin/cryptoflow*
fi
